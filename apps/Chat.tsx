        ...
        >
             ...
             {(osTheme.chatChromeCustomCss || osTheme.chatBubbleCustomCss || char.chromeCustomCss || char.chatBubbleCustomCss || activeTheme.customCss || (char as any).thinkingChainCustomCss) && (
               <style>{`
                 ...
                 .sully-bubble-tail{position:absolute!important;display:block!important;width:8px!important;height:8px!important;margin:0!important;padding:0!important;background:var(--sully-bubble-tail-bg,var(--sully-bubble-bg,#b8b8b8))!important;border:0!important;box-shadow:none!important;clip-path:polygon(100% 0,100% 100%,0 50%)!important;filter:drop-shadow(0 0 1px var(--sully-bubble-tail-border,#555))!important;z-index:2!important;pointer-events:none!important;}
                 ...
                 `}
                 .sully-bubble-tail{background:var(--sully-bubble-tail-bg,var(--sully-bubble-bg,#b8b8b8))!important;clip-path:polygon(100% 0,100% 100%,0 50%)!important;filter:drop-shadow(0 0 1px var(--sully-bubble-tail-border,#555))!important;}
