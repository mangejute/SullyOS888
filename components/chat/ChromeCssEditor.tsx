...
.sully-bubble-ai{--sully-bubble-bg:#dedede;--sully-bubble-tail-bg:#dedede;--sully-bubble-tail-border:#555!important;--sully-bubble-text:#222;background:linear-gradient(#f7f7f7,#d8d8d8)!important;color:#222!important;border:1px solid #b8b8b8!important;border-radius:4px!important;box-shadow:inset 0 1px #fff,0 1px 2px rgba(0,0,0,.18)!important;position:relative!important;padding:.28rem .72rem!important;min-height:1.75rem!important;display:flex!important;align-items:center!important;}
.sully-bubble-user{--sully-bubble-bg:#343434;--sully-bubble-tail-bg:#343434;--sully-bubble-tail-border:#1d1d1d;--sully-bubble-text:#fff;background:linear-gradient(#4a4a4a,#282828)!important;color:#fff!important;border:1px solid #1d1d1d!important;border-radius:4px!important;box-shadow:inset 0 1px rgba(255,255,255,.16),0 1px 2px rgba(0,0,0,.35)!important;position:relative!important;padding:.28rem .72rem!important;min-height:1.75rem!important;display:flex!important;align-items:center!important;}
...
.sully-bubble-with-reply > .sully-bubble-tail{background:var(--sully-bubble-tail-bg,var(--sully-bubble-bg,#b8b8b8))!important;top:calc(var(--sully-chat-avatar-size,1.75rem) / 2)!important;}
...
.sully-bubble-tail{position:absolute!important;top:50%!important;width:8px!important;height:8px!important;margin:0!important;padding:0!important;background:transparent!important;border:0!important;box-shadow:none!important;clip-path:none!important;transform:translateY(-50%)!important;z-index:2!important;pointer-events:none!important;}
.sully-bubble-tail::before{content:""!important;position:absolute!important;inset:0!important;background:var(--sully-bubble-tail-border,#6d6d6d)!important;clip-path:polygon(100% 0,100% 100%,0 50%)!important;}
.sully-bubble-tail::after{content:""!important;position:absolute!important;inset:1px!important;background:var(--sully-bubble-tail-bg,var(--sully-bubble-bg,#b8b8b8))!important;clip-path:polygon(100% 0,100% 100%,0 50%)!important;}
